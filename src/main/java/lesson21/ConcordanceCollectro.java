...
public class ConcordanceCollectro {
    public static void main(String[] args) {
        ...
        System.out.println(getConcordance2(lines));
    }
    ...
    public static Map<String, Set<Integer>> getConcordance(List<String> lines) {
        return  IntStream.range(0, lines.size())
                ...
                .flatMap(pair -> Arrays.stream(
                        pair.getValue().split(" ")).map(word -> new AbstractMap.SimpleEntry<String, Integer>(word, pair.getKey()))
                )
                .collect(new Collector<
                        AbstractMap.SimpleEntry<String, Integer>, // тип элемента в потоке
                        Map<String, Set<Integer>>, // тип в который происходит аккуиуляция
    ...
    public static Map<String, Set<Integer>> getConcordance2(List<String> lines) {
