...
public class Lesson13 {
    // Comparing objects in Java. Comparable, Comparator. Method sort.
    public static void main(String[] args) {
        ...
        System.out.println("Comparable by name " + team);
...
//        );
        ...
        Collections.sort(
                team,
                (o1, o2) -> o2.getName().compareTo(o1.getName()) // SAM
        );

        Comparator<Player> reverseName = (o1, o2) -> o2.getName().compareTo(o1.getName());

        System.out.println("name Comparator reversed " + team);
        // отсортровать игроков по их именам по возрастанию и потом по возрасту по убыванию

        // напишите лямбду для сортировки по возрасту
        // до 21:20
